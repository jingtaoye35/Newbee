"""StateTracker: data/_Manifest/Data_State.json 读写.

设计:
  - 单一文件 data/_Manifest/Data_State.json
...
from newbee.datasource.storage.io import CoverageStats
...
DEFAULT_STATE_PATH = PROJECT_ROOT / "data" / MANIFEST_DIR_NAME / STATE_FILE_NAME
