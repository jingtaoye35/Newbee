...
from alpha_backend.datasource.registry import DataType
...
class DataFile:
    ...
    def _assert_schema_fresh(self) -> None:
        ...
        from alpha_backend.datasource.storage.state import DEFAULT_STATE_PATH, StateTracker

        # DataFile.path = root / dtype.storage_path; state 路径 = (datas 目录)/_Manifest/Data_State.json
        # 例如: datas/KData.parquet → datas/_Manifest/Data_State.json
