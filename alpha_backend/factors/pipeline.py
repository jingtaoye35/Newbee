...
注意: pipeline 只负责"批量调因子", 不负责数据加载 (那是 datas.storage 的事).
"""
...
from alpha_backend.factors.base import FactorSpec, SimpleFactor, n_nonan
from alpha_backend.factors.registry import get as get_factor
...
def decile_returns(
    ...
    try:
        ...
        # ties 太多, 用 rank 分组
        from alpha_backend.factors.base import rank_
