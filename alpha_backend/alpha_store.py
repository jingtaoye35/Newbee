...
设计:
  - `datas/alpha/{strategy_id}/{date}.npy` 每天一个 ndarray(N,)
  - `datas/alpha/{strategy_id}/manifest.json` 记录 universe_sha / model_v / range / sha
...
class AlphaStore:
    ...
    路径约定:
      ...
      - 例: ``AlphaStore(Path("datas/alpha/momentum_20_1.0"), pool)``
